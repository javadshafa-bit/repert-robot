        ...
        <div class="w-full flex items-center justify-between gap-x-1.5">
            ...
            <ul class="flex items-center gap-1.5">
                <li class="inline-flex items-center gap-1 relative pe-1.5">
                    <a class="shrink-0 inline-flex justify-center items-center bg-primary size-8 rounded-md text-xl font-semibold focus:outline-hidden focus:opacity-80"
                       href="{{ route('admin.dashboard') }}">
                        <svg class="shrink-0 size-5 text-white" width="36" height="36" viewBox="0 0 24 24" fill="none"
        ...
        <div class="lg:pt-13 relative flex flex-col h-full max-h-full">
            ...
            <nav class="p-3 size-full flex flex-col overflow-y-auto">
                ...
                <div class="pt-3 flex flex-col border-t border-sidebar-2-divider first:border-t-0 first:pt-0">
                    <span class="block pe-2.5 mb-2 font-medium text-xs uppercase text-muted-foreground-1">منوی
                        اصلی</span>
                ...
                <div class="pt-3 mt-3 flex flex-col border-t border-sidebar-2-divider">
                    <span class="block pe-2.5 mb-2 font-medium text-xs uppercase text-muted-foreground-1">مدیریت
                        اطلاعات</span>
                    <ul class="flex flex-col gap-y-1">
                        <li>
